...
```sh
python3 utilities/tokenize_ctsdata.py corpus.cex > tokenized.txt
```
...
```sh
python3 utilities/analyze_tokendata_to_files.py tokenized.txt --output-dir analyses/
python3 utilities/analyze_tokendata_to_files.py a.txt b.txt --output-dir analyses/
```
...
```sh
python3 utilities/analyze_w_diagrams.py corpus.cex --output-dir out/
```
...
```sh
python3 utilities/analyze_tokendata_w_diagrams.py tokenized.txt --output-dir out/
python3 utilities/analyze_tokendata_w_diagrams.py a.txt b.txt --output-dir out/
```

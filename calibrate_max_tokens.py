"""
Calibrates arsgrammatica/token_budget.py's max_tokens estimate against real
...
arsgrammatica/token_budget_calibration.json, where
...
real-world passages -- the fit is a genuine measurement over that range,
but treat max_tokens estimates for much longer passages as an
extrapolation, and lean on token_budget.py's safety_margin/ceiling/retry

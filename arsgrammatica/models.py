...
class Token(BaseModel):
    """A single pre-segmented token with a stable id, produced by tokenizer.py
    *before* the passage is sent to the LM."""

    id: str = Field(description="Stable token id assigned during pre-tokenization, e.g. 't0', 't1', ...")
    text: str = Field(description="The token's surface text, exactly as it appears in the passage.")

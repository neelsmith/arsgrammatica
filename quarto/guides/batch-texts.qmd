...
```sh
python3 utilities/analyze_ctsdata_to_files.py corpus.cex 
     --output-dir analyses/
```
...
```sh
python3 utilities/group_ctsdata_by_sentence.py aeneid.cex
```
...
```sh
python3 utilities/group_ctsdata_by_sentence.py aeneid.cex > aeneid-linegroups.txt
```
...
```sh
python3 utilities/tokenize_ctsdata.py corpus.cex > tokens-sentences.cex
```

For details of the output format, see [the reference documentation](../reference).

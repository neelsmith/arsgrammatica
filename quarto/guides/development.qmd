# Using and training language models with `arsgrammatica`



This document describes how you can incorporate your results from reading real Latin texts with `arsgrammatica` into a repeatable development loop that constantly improves the package.
